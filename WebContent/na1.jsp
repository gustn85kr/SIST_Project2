...
<script src="textarea\js\tinymce\tinymce.min.js"></script>
...
$(document).ready(function(){
   ...
   /*       select: function(start, end) {
       ...
       /* addListPanelCreation addListPanelCancel */
         ...
         $(this).on("click",".listTitleBtn",function(){
           ...
           $.ajax({
               ...
               " <textarea cols='30' rows='3' id='cardaddcontent'></textarea><input type='button' value='취소' class='cardCancel btn-primary' id='cardCancelBtn'/>"+
     ...
     $(this).on("click","#dateBtn",function(){
      ...
      $(this).on("click","#cardCancelBtn ",function(){
          $('.footInput').hide();
          $(this).siblings('#cardaddcontent').val("");
           $(this).parent('.footInput').siblings('#listtitleaddbtn').show();
      });
